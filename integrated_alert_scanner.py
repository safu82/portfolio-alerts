...
# Step 1.5: Auto-archive old alerts
    ...
    print(f"  Configuration: Daily RSI EMA(9) > {BLUE_ZONE_CONFIG['daily_rsi_threshold']}, Weekly RSI EMA(9) > {BLUE_ZONE_CONFIG['weekly_rsi_threshold']}, within {BLUE_ZONE_CONFIG['datr_multiplier']} DATR of 52W high")
